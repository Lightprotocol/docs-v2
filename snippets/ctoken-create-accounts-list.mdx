<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>-</td>
      <td>
        - Config account owned by LightRegistry.<br/>
        - Stores rent parameters: `rent_sponsor`, `compression_delay`, `rent_config`.<br/>
    ...
    <tr>
      ...
      <td>mutable</td>
      <td>
        - CToken program PDA that fronts rent exemption (~0.002 SOL) at creation.<br/>
        - Claims rent when account compresses.<br/>
      </td>
    </tr>
  </tbody>
</table>
