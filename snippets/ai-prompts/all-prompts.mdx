...
Copy the prompt below or view the [guide](/light-token/toolkits/for-wallet-adapter).
<WalletAdapter />
</Accordion>
...
Copy the prompt below or view the [guide](/light-token/toolkits/sponsor-top-ups).
<SponsorTopUps />
</Accordion>
