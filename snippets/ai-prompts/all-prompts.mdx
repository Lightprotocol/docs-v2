...
import SponsorTopUps from "/snippets/ai-prompts/wallets/sponsor-top-ups.mdx";
...
<Accordion title="Sponsor rent top-ups">
Copy the prompt below or view the [guide](/light-token/wallets/sponsor-top-ups).
<SponsorTopUps />
</Accordion>
