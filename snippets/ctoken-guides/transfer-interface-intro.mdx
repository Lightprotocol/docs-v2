...
* You can use this to **convert existing SPL tokens to c-Tokens** with **sponsored rent-exemption**. Learn more in the [core concepts to the c-Token program](/compressed-token-program/README.mdx).
</Tip>
