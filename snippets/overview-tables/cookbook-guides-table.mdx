<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Convert between SPL/T22 and c-token</td>
      <td style={{textAlign: "center"}}>x</td>
      <td style={{textAlign: "center"}}></td>
      <td style={{textAlign: "center"}}></td>
    </tr>
    <tr>
      <td><a href="/light-token/cookbook/compress-decompress">Compress & Decompress</a></td>
      <td>Convert between SPL and cold storage</td>
      <td style={{textAlign: "center"}}>x</td>
      <td style={{textAlign: "center"}}></td>
      <td style={{textAlign: "center"}}></td>
    </tr>
    <tr>
      <td><a href="/light-token/cookbook/delegate">Delegate</a></td>
      <td>Approve & revoke token delegation</td>
      <td style={{textAlign: "center"}}>x</td>
      <td style={{textAlign: "center"}}></td>
      <td style={{textAlign: "center"}}></td>
    </tr>
    <tr>
      <td><a href="/light-token/cookbook/load-ata">Load ATA</a></td>
      <td>Load cold balance to hot ATA</td>
      <td style={{textAlign: "center"}}>x</td>
      <td style={{textAlign: "center"}}></td>
      <td style={{textAlign: "center"}}></td>
    </tr>
    <tr>
      <td><a href="/light-token/cookbook/merge-token-accounts">Merge Accounts</a></td>
      <td>Consolidate compressed accounts</td>
      <td style={{textAlign: "center"}}>x</td>
      <td style={{textAlign: "center"}}></td>
      <td style={{textAlign: "center"}}></td>
    </tr>
