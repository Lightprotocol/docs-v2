<table>
  ...
  <tbody>
    ...
    <tr>
      <td>6</td>
      <td style={{textAlign: 'left'}}><strong><Tooltip tip="cTokenpN6n8uj2gwJJszLDaeMpJt6aVqGbPWLJbvTFg2" cta="Program ID" href="https://solscan.io/account/cTokenpN6n8uj2gwJJszLDaeMpJt6aVqGbPWLJbvTFg2">cToken Program</Tooltip></strong></td>
      <td>-</td>
      <td>
      - Program to create and interact with cMints, cTokens and compressed tokens.
      - Your program calls this to create the cToken account.
      </td>
    </tr>
  </tbody>
</table>