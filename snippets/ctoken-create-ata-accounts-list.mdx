<table>
  ...
  <tbody>
    <tr>
      ...
      <td>-</td>
      <td>
        - The wallet that will own this ATA.<br/>
    ...
    <tr>
      <td>3</td>
      <td style={{textAlign: 'left'}}><strong>Associated Token Account</strong></td>
      <td>mutable</td>
      <td>
        - The cATA being created.<br/>
        - Address is derived from owner + mint + cToken program ID.<br/>
      </td>
    </tr>
    <tr>
      <td>4</td>
