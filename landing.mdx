...
|  Creation Cost                    | Solana Accounts     | ZK Compression         | Use Case            |
|:---------------------|:-------------------|:----------------|:--------------------|
| **100-byte PDA**     | ~1,600,000 lamports | 15,000 lamports | App State           |
| **Mint Account**     | ~1,500,600 lamports | 15,000 lamports | Mints with Metadata |
| **Token Account**    | ~2,039,280 lamports | 22,288 lamports | Tokens             |
...
<CardGroup cols={3}>
  <Card
    title="c-Mints and c-Tokens"
    href="/compressed-token-program/overview"
    icon="coins"
    iconType="solid"
  >
