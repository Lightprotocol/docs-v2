...
<CardGroup cols={2}>
  <Card title="Client SDKs" icon="code" href="/resources/sdks/client-development">
    TypeScript and Rust client libraries.
  </Card>
  <Card title="Program SDKs" icon="cube" href="/resources/sdks/program-development">
    Build programs with compressed accounts.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Compressed Tokens" icon="coins" href="/compressed-tokens/overview">
    For token distribution and storage of inactive tokens.
  </Card>
  <Card title="JSON RPC Methods" icon="brackets-curly" href="/api-reference/json-rpc-methods/overview">
    Compression RPC API reference.
  </Card>
</CardGroup>
