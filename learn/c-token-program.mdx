...
* A wallet needs a c-Token account for each c-Mint it wants to hold, with the wallet address set as the c-Token account owner.
...
<Card
  title=" Learn how to create c-Mints"
  icon="chevron-right"
  color="#0066ff"
