...
Compressed accounts store state as call data on <Tooltip tip="The ledger is an immutable historical record of all Solana transactions signed by clients since the genesis block.">Solana's ledger</Tooltip>, removing rent per account.
</Step>
<Step>
...
<Card
  title=" Learn more about the compressed account model."
  icon="chevron-right"
  color="#0066ff"
  href="/learn/core-concepts/compressed-account-model"
  horizontal
>
</Card>