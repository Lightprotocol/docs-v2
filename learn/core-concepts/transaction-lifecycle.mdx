...
keywords: ["compressed transaction lifecycle", "zk compression transactions"]
---
...
<Card
  title="Understand the trade-offs for compressed accounts."
  icon="chevron-right"
  color="#0066ff"
  href="/learn/core-concepts/considerations"
  horizontal
>
</Card>