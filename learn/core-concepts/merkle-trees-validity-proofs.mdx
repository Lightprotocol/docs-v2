...
keywords: ["merkle trees on solana", "validity proofs solana", "zk proofs on solana"]
---
...
<Frame caption="A Binary state Merkle tree, with depth 3 and proof path for Leaf 1.
...
<Card
  title="Learn about the lifecycle of a transaction with compressed accounts."
  icon="chevron-right"
  color="#0066ff"
  href="/learn/core-concepts/transaction-lifecycle"
  horizontal
>
</Card>