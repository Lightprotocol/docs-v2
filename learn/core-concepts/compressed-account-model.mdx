...
<Info>
Learn more about address derivation for a [Typescript Client here](https://github.com/Lightprotocol/developer-content/blob/main/zk-compression-docs/compressed-pdas/client-library/typescript.md#derive-address).
</Info>
...
<Info>
Learn more about address derivation for a [Rust Client here](https://github.com/Lightprotocol/developer-content/blob/main/zk-compression-docs/compressed-pdas/client-library/rust.md#derive-address).
</Info>
...
<Note>
Learn how the Light-Token Program uses ZK Compression under the hood [here](/learn/light-token-standard).
</Note>
