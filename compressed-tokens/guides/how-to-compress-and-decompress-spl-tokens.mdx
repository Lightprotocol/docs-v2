...
description: "Guide to compress and decompress SPL tokens, troubleshooting and advanced configurations."
---
...
import MintPrereq from '/snippets/compressed-tokens-mint-prereq.mdx';
...
<Card
  title="Learn how to compress complete token accounts to reclaim rent afterwards."
  icon="chevron-right"
  color="#0066ff"
  href="/compressed-tokens/guides/how-to-compress-complete-spl-token-accounts"
  horizontal
/>
