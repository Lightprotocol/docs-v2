...
## Recommended Usage of Compressed Tokens
  ...
  * [c-Tokens](/compressed-token-program/README.mdx) are automatically compressed/decompressed, when active/inactive and include **sponsored rent-exemption**. [Learn more here](/compressed-token-program/README.mdx).
  </Card>
<Note>
