...
4. Wallets like Phantom and Backpack support compressed tokens. The UI does not distinguish between SPL and compressed tokens.
...
## Recommended Usage of Compressed Tokens
  ...
  #### [Token Distribution](#advanced-guides)
    ...
    * Cost reduction for airdrops, rewards, etc:
