...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>`getAtaInterface` returns the Light Token ATA balance for a given mint. To include compressed (cold), SPL, and Token 2022 balances, call `loadAta` first to unify them into the ATA.</td>
    </tr>
    <tr>
      <td>**Wrap / Unwrap**</td>
