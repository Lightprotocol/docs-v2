---
title: "c-Token Toolkit for Indexing Mints"
sidebarTitle: "for Indexing Mints"
description: "Guide to index transaction to parse c-Mints and metadata using Laserstream."
---
...
<Note>
Find devnet examples at [c-token-toolkit/streaming-tokens](https://github.com/Lightprotocol/c-token-toolkit).
</Note>
...
<Card
  title="Toolkit to stream c-Token accounts"
  icon="chevron-right"
  color="#0066ff"
  href="/c-token-program/c-token-toolkits/for-streaming-tokens"
  horizontal
/>