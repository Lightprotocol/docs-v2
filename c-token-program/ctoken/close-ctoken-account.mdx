...
sidebarTitle: Close Token Accounts
description: Program guide to close light-token accounts via CPI to the light-token Program with step-by-step implementation and full code examples.
---
...
1. The example creates a test light-mint and light-token account.
...
# Next Steps
  ...
  <Card
    title="Go back to the light-token overview"
    icon="chevron-right"
    color="#0066ff"
