...
* You can use this to **convert existing SPL tokens to light-tokens** with **sponsored rent-exemption**.
</Tip>
...
The example transfers light-tokens between light-token accounts.
...
To ensure the recipient's ATA exists, prepend an idempotent creation instruction:
...
# Next Steps
  ...
  <Card
    ...
    icon="chevron-right"
    color="#0066ff"
    href="/c-token-program/ctoken/close-ctoken-account"
    horizontal
  />
