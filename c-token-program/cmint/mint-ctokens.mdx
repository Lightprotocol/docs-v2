...
description: Program guide to mint light-tokens to a light-mint via CPI to the Compressed Token Program with step-by-step implementation and full code examples.
---
...
The example mints light-tokens to a recipient address.
...
<Card
  ...
  icon="chevron-right"
  color="#0066ff"
  href="/c-token-program/ctoken/transfer-interface"
  horizontal
>
</Card>
