---
title: Create light-mint
description: Program and client guide to create a light-mint with token metadata via CPI to the light-token Program. Includes step-by-step implementation and full code examples.
---
...
The example creates a light-mint with the specified decimals and mint authority.
