---
title: Create cMint
description: Program and client guide to create a cMint with token metadata via CPI to the c-Token Program. Includes step-by-step implementation and full code examples.
---
