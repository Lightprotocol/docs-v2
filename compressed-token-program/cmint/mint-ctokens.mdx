...
2. Build the instruction with `MintToCToken::new()`.
```rust
use light_compressed_token_sdk::ctoken::MintToCToken;
...
3. Send transaction with payer as signer. <br/>
Only the mint authority can mint new c-Tokens.
