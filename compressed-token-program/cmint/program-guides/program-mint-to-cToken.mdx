---
title: Mint cTokens
description: Program guide to mint cTokens to a cMint via CPI to the Compressed Token Program with step-by-step implementation and full code examples.
---
...
1. cTokens increase the supply of a cMint.
2. The destination cToken accounts must exist to receive the minted cTokens.
3. Only the mint authority can mint new cTokens.
