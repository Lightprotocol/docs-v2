---
title: Mint c-Tokens
description: Program guide to mint c-Tokens to a cMint via CPI to the Compressed Token Program with step-by-step implementation and full code examples.
---
...
1. c-Tokens increase the supply of a cMint.
