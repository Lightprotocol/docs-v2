---
title: Create cMint Accounts with Token Metadata
description: Program guide to create cMint accounts with token metadata. Includes step-by-step implementation and full code examples.
---
...
3. The `mint_signer` keypair/PDA derives the mint address.
