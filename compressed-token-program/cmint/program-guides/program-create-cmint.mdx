---
title: Create cMint
description: Program guide to create a cMint with token metadata via CPI to the cToken Program. Includes step-by-step implementation and full code examples.
---
