...
Build system accounts info required to interact with compressed state. The client includes them in the instruction.
...
### Build Mint to cToken Infos and CPI the cToken Program
