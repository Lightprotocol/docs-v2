...
description: Program guide to create associated c-Token accounts with step-by-step implementation and full code examples.
---
...
<Card
  ...
  icon="chevron-right"
  color="#0066ff"
  href="/compressed-token-program/ctoken/client-guides/client-create-c-ATA"
  horizontal
>
