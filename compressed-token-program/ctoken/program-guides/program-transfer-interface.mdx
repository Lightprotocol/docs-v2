...
description: Program guide for transfers between c-Token and SPL token accounts via CPI. The interface detects account types and invokes the right programs.
