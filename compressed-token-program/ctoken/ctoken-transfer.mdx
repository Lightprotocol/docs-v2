---
title: Transfer cToken to cToken account
description: Transfer tokens between two cToken accounts.
---


Transfers tokens between two cToken accounts. Follows SPL Token semantics and includes automatic rent top-ups for compressible accounts.
