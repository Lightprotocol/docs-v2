...
1. cToken accounts are Solana accounts that hold token balances of cMints, SPL mints, or Token 2022 mints.
...
3. Send transaction & verify cToken account creation with `get_account`. <br/>
