...
1. Creates SPL mint, SPL token accounts, and mint SPL tokens
2. Sends SPL tokens to c-Token account. c-Tokens are minted.
3. Transfers c-Tokens to another c-Token account.
...
SPL Mint: SPLToken -> cToken and cToken -> cToken
