...
4. Send transaction & verify c-ATA creation with `get_account`. <br/>
c-ATAs are Solana accounts and use your familiar RPC methods.
...
async fn test_create_cata_client() {
    ...
    let instruction = CreateAssociatedTokenAccount2::new(
        payer.pubkey(),
        owner,
        mint,
