...
description: Guide to create a cToken account using the cSDK.
---
...
<Info>
cToken accounts are compressible with rent-exemption sponsorship. The protocol funds the account's rent exemption at creation, and the account compresses automatically when inactive for ~84 minutes (12,600 slots).
</Info>
...
<Card
  title="Mint tokens to your cToken account"
  icon="chevron-right"
  color="#0066ff"
