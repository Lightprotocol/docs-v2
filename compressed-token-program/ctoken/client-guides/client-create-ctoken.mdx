...
1. Create a test cMint. You can use existing SPL or Token 2022 mints as well.
2. Build instruction with the default rent config in `CompressibleParams::default()`.
```rust
...
```
<Accordion title="CompressibleParams">
This struct contains the default rent config and associated accounts.
<CTokenConfigureRent />
</Accordion>
