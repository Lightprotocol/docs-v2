---
title: Mint cTokens
description: Client guide to mint compressed tokens to cToken accounts with step-by-step implementation and full code examples.
---
...
async fn mint_to_ctoken(
    ...
    println!("Tokens minted to cToken ATAs!");
