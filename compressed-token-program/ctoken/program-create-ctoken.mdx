...
description: Guide to create compressible cToken accounts via CPI from Solana programs.
---
...
Build `CompressibleParamsInfos` with the rent configuration:
...
Build `CreateCTokenAccountInfos` with account references:
