...
2. The account creator top-ups the lamport balance with rent for at least two epochs (27,000 slots / 3h)
3. The transaction payer top-ups the lamports balance when the account's lamports balance is below 2 epochs.
4. The account will be compressed when inactive for a period of 27,000 slots (3h).
