    ...
    <tr>
      ...
      <td style={{textAlign: 'left'}}>
        <ul>
          ...
          <li>Optional **sponsored rent** exemption via [compressible extension](#compressible)</li>
    ...
    <tr>
      ...
      <td style={{textAlign: 'left'}}>
        <ul>
          ...
          <li>Solana accounts with the **[compressible extension](#compressible) are automatically compressed/decompressed** accounts when active/inactive.</li>
        </ul>
      </td>
    </tr>
  </tbody>
...
* Solana accounts with the [compressible extension](/compressible/compressible) are automatically compressed with no writes in 6300 slots (1.75 hours), and decompressed with new writes.
</Tip>
...
<Tip>
**Both SPL and cToken ATAs** can implement the **[compressible extension](/compressible/compressible) for sponsored rent exemption**.
</Tip>
