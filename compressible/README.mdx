...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{textAlign: 'left'}}>
        <ul>
          <li>**SPL-compatible token accounts** (derived from cMints)</li>
    ...
    <tr>
      ...
      <td style={{textAlign: 'left'}}>
        <ul>
          ...
          <li>Use for **token distribution** (for airdrops, payments, etc.)</li>
          <li>The **[compressible extension](#compressible) automatically compresses/decompresses** accounts when active/inactive.</li>
        </ul>
      </td>
    </tr>
  </tbody>
...
* Use the **[compressible extension](/compressible/compressible) to optimize rent**. Accounts are compressed with no writes in 6300 slots (1.75 hours). Accounts are decompressed when they receive a write.
</Tip>
  ...
  <Tab title="Diagram">
    <Frame>
      <img
        ...
        alt="CompressedMint structure diagram showing three fields: base (BaseMint) containing mint_authority, supply, decimals, is_initialized, and freeze_authority for SPL mint layout; metadata (CompressedMintMetadata) used by the Compressed Token Program for cMint state; and extensions (Option<Vec<ExtensionStruct>>) field for Token Metadata extension"
      />
    </Frame>
  </Tab>
...
<table>
  <thead>
    <tr>
      ...
      <th style={{width: '45%', textAlign: 'left'}}>cMint (BaseMint)</th>
      <th style={{width: '30%', textAlign: 'left'}}>SPL Mint</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <tr>
      <td>supply</td>
      <td colspan="2" style={{textAlign: 'center'}}>u64</td>
    </tr>
    <tr>
      <td>decimals</td>
      <td colspan="2" style={{textAlign: 'center'}}>u8</td>
    </tr>
    <tr>
      <td>is_initialized</td>
      <td colspan="2" style={{textAlign: 'center'}}>bool</td>
    </tr>
    <tr>
...
<Tip>
Use the **[compressible extension](/compressible/compressible) to optimize rent**. Accounts are automatically compressed when inactive and decompressed when active.
</Tip>
  ...
  <Tab title="Diagram">
    <Frame>
      <img
        ...
        alt="CToken structure diagram showing fields: mint, owner, amount, delegate, state, is_native, delegated_amount, close_authority, and extensions field for optional extensions like compressible"
      />
    </Frame>
  </Tab>
  <Tab title="Source Code">
...
<table>
  <thead>
    <tr>
      <th style={{width: '10%', textAlign: 'left'}}>Field</th>
      <th style={{width: '45%', textAlign: 'left'}}>cToken</th>
      <th style={{width: '30%', textAlign: 'left'}}>SPL Token Account</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>mint</td>
      <td colspan="2" style={{textAlign: 'center'}}>Pubkey</td>
    </tr>
    <tr>
      <td>owner</td>
      <td colspan="2" style={{textAlign: 'center'}}>Pubkey</td>
    ...
    <tr>
      <td>extensions</td>
      <td>Option&lt;Vec&lt;ExtensionStruct&gt;&gt;</td>
      <td>-</td>
    </tr>
  </tbody>
</table>
...
<Tip>
**Both SPL and cToken ATAs** can implement the **[compressible extension](/compressible/compressible) to optimize rent**. Accounts are automatically compressed when inactive and decompressed when active.
</Tip>
  ...
  <Tab title="Diagram">
    <Frame>
      <img
        ...
        alt="TokenData structure diagram showing fields: mint, owner, amount, delegate, state, and tlv placeholder for TokenExtension data"
      />
    </Frame>
  </Tab>
  <Tab title="Source Code">
