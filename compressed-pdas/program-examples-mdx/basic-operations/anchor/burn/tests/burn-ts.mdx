---
title: "basic-operations/anchor/burn/tests/burn.ts"
description: "https://github.com/Lightprotocol/program-examples/blob/main/basic-operations/anchor/burn/tests/burn.ts"
---
