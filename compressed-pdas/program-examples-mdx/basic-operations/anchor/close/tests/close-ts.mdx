---
title: "basic-operations/anchor/close/tests/close.ts"
description: "https://github.com/Lightprotocol/program-examples/blob/main/basic-operations/anchor/close/tests/close.ts"
---
