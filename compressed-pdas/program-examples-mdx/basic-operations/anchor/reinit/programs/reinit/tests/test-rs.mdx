---
title: "basic-operations/anchor/reinit/programs/reinit/tests/test.rs"
description: "https://github.com/Lightprotocol/program-examples/blob/main/basic-operations/anchor/reinit/programs/reinit/tests/test.rs"
---
