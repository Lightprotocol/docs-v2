---
title: "zk-id/README.md"
description: "https://github.com/Lightprotocol/program-examples/blob/main/zk-id/README.md"
---
...
- **Light CLI**: Install with `npm i -g @lightprotocol/zk-compression-cli@alpha`
