...
* A rent-free alternative are compressed addresses with similar functionality and derivation. This way you can insert nullifiers at a fraction of the cost to create a PDA.
...
<Info>
This example does not require a custom circuit. [See full example with tests on Github](https://github.com/Lightprotocol/program-examples/tree/main/zk-id).
</Info>
...
<Note>
Find the [full example here](https://github.com/Lightprotocol/program-examples/blob/99d260f9f356743b8fe3501c684f7926930d6079/zk-id/circuits/compressed_account.circom)
</Note>
