...
Rent-free PDA accounts for on-chain programs.
...
<CardGroup cols={3}>
  <Card title="Nullifiers" icon="code-commit" href="/compressed-pdas/guides/how-to-create-nullifier-pdas">
    System for payments and AI agents to prevent your onchain instruction from being executed more than once.
  </Card>
  <Card title="ZK" icon="shield-check" href="/zk/overview">
    How to build a ZK program on Solana with nullifiers, groth-16 proofs and merklelized state.
  </Card>
...
<CardGroup cols={2}>
  <Card title="light-token" icon="coins" href="https://docs.rs/light-token/latest/light_token/">
    Light Token program SDK.
  </Card>
