...
<CardGroup cols={2}>
  <Card
    ...
    icon="js"
    href="/api-reference/libraries/stateless-js"
  >
  ...
  <Card
    ...
    icon="coins"
    href="/api-reference/libraries/compressed-token"
  >
...
<CardGroup cols={3}>
  <Card
    title="light-client"
    icon="rust"
    href="/api-reference/libraries/light-client"
  >
  ...
  <Card
    title="light-sdk"
    icon="cube"
    href="/api-reference/libraries/light-sdk"
  >
  ...
  <Card
    ...
    icon="flask-vial"
    href="/api-reference/libraries/light-program-test"
  >
