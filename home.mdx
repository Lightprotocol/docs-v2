...
{/* Hero - all styles in components, container styles will be stripped but that's OK */}
<div style={{position: 'relative', textAlign: 'center', padding: '140px 32px 146px', width: '100%', overflow: 'hidden', borderBottom: '1px solid #e5e7eb', background: '#FAFAFA'}}>
  <HeroCubeGrid />
...
<CardGroup cols={2}>
  <Card title="" icon="expand" href="/light-token/welcome">
    ### Light-Token Program (Beta) High performance token standard for Defi and
    Payments.
  </Card>
  <Card title="" icon="compress" href="/welcome">
    ### ZK Compression For token distribution and app state.
  </Card>
</CardGroup>
## Features
...
<CardGroup cols={2}>
  <Card title="Light-Token" icon="coins" href="/light-token/cookbook/overview">
