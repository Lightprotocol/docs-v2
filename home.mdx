...
<div style={{
  ...
  <HeroCubeGrid />
  <LiquidGlassPill>
    <h1 style={{position: 'relative', fontSize: '2.5rem', fontWeight: 500, margin: 0, color: '#111827'}}>Build and Scale with ZK Compression.</h1>
  </LiquidGlassPill>
...
<CardGroup cols={2}>
  <Card
    title="Light-Token"
    icon="coins"
    href="/light-token/cookbook/overview"
  >
