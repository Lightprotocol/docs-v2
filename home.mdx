...
{/* Simple hero - no fancy JSX components */}
<div className="text-center py-36 border-b border-gray-200 bg-gray-50">
  <h1 className="text-4xl font-medium text-gray-900">Scale Anything on Solana.</h1>
</div>
