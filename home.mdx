...
<div style={{
  position: 'relative',
  textAlign: 'center',
  padding: '197px 32px 146px',
  width: '100%',
  overflow: 'hidden',
  borderBottom: '1px solid #e5e7eb'
}}>
  <HeroBackground />
  <h1 style={{position: 'relative', fontSize: '3rem', fontWeight: 500, marginBottom: '16px', color: '#111827'}}>Build and Scale <br/>with Light Protocol</h1>
