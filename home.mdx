...
<Tabs>
  ...
  <Tab title="Compressed Tokens">
      ...
      icon="parachute-box"
      color="#0066ff"
      href="/compressed-tokens/for-developers/airdrop-tokens"
      horizontal
    >
    ...
    <Card
      ...
      icon="hand-holding"
      color="#0066ff"
      href="/compressed-tokens/for-developers/example-airdrop-with-claim"
      horizontal
    >
    ...
    <Card
      ...
      icon="layer-group"
      color="#0066ff"
      href="/compressed-tokens/for-developers/multi-instruction-transactions"
      horizontal
    >
    ...
    <Card
      ...
      icon="wallet"
      color="#0066ff"
      href="/compressed-tokens/for-wallets"
      horizontal
    >
      Display and manage compressed tokens in your wallet.
    </Card>
    ...
    <Card
      ...
      icon="coins"
      color="#0066ff"
      href="/compressed-tokens/for-developers/token-2022"
      horizontal
    >
    ...
    <Card
      ...
      icon="browser"
      color="#0066ff"
      href="/compressed-tokens/for-developers/example-web-client"
      horizontal
    >
    ...
    <Card
      ...
      icon="node-js"
      color="#0066ff"
      href="/compressed-tokens/for-developers/example-nodejs-client"
      horizontal
    >
