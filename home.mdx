...
<div className="relative text-center py-32 md:py-40 w-full overflow-hidden border-b border-gray-200">
  <HeroCubeGrid />
...
<CardGroup cols={2}>
  <Card
    title="Light-Token Program (Beta)"
    icon="expand"
    href="/light-token/welcome"
  >
    High performance token standard for DeFi and Payments.
  </Card>
  <Card title="ZK Compression" icon="compress" href="/welcome">
