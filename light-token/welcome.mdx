...
<Info>
  **Note: This page is for the new Light Token Program Beta.** For production use today, use [ZK
  Compression](/compressed-tokens/overview), which are live on Solana Mainnet and supported by
  leading wallets such as Phantom & Backpack.
</Info>
