...
description:   High-performance token standard that is functionally equivalent to SPL while reducing account creation cost BY 200X and increasing CU efficiency on hot paths. The Light Token SDK keeps code changes minimal and is a superset of the SPL-token API.
