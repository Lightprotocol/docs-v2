---
title: The Light Token Program (Beta)
...
<CardGroup cols={2}>
  <Card title="" icon="coins">
    ### Mint Accounts * Uniquely represent a token and store its global
    metadata. * light-mints are compressed accounts and rent-free.
  </Card>
  <Card title="" icon="wallet">
    ### Token Accounts * Each light-token account can hold units of one light,
    SPL, or Token 2022 mint. * Custom rent config reduces account creation cost.
  </Card>
</CardGroup>
