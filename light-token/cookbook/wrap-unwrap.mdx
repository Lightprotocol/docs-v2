---
title: Wrap & Unwrap SPL/T22 <> Light Token Accounts
sidebarTitle: Wrap & Unwrap for on/off-ramp
description: Convert between SPL/T22 token and light-token accounts. Used for on/off-ramp to centralized exchanges that only support SPL.
---
...
async function main() {
  ...
  console.log("Wrapped 500 tokens to light-ATA");
