...
import NativeProgramCode from "/snippets/code-snippets/light-token/create-mint/native-program/full-example.mdx";
...
<Info>
  ...
  [examples-light-token](https://github.com/Lightprotocol/examples-light-token/tree/main/program-examples/anchor/macro-basics/create-mint-macro).
</Info>
