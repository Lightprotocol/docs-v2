...
sidebarTitle: Create Light / SPL / Token 2022 Mint Account
description: Create a Light mint with token metadata, or create SPL and Token 2022 mints with interface PDA for interoperability.
