...
import NativeProgramCode from "/snippets/code-snippets/light-token/transfer-interface/native-program/full-example.mdx";
...
<Info>
  ...
  [examples-light-token](https://github.com/Lightprotocol/examples-light-token/tree/main/program-examples/anchor/programs/transfer-interface).
</Info>
