...
```toml
[dependencies]
light-client = { git = "https://github.com/Lightprotocol/light-protocol" }

# Program-specific SDK that implements LightProgramInterface (provided by AMM team)
example-amm-sdk = "0.1"
```
...
| Resource | Link |
|----------|------|
| AMM Program | [...](https://github.com/...) |
| LightProgramInterface Trait Impl | [...](https://github.com/...) |
| Client Test | [...](https://github.com/...) |
...
Questions or need hands-on support? Send a [DM](https://t.me/swen_light), [email](mailto:support@lightprotocol.com) or join our [Discord](https://discord.com/invite/7cJ8BhAXhu).
</Callout>