...
cost savings). Your instructions stay the same.
...
If you have an existing program that you would like to migrate to rent-free accounts, [contact us](https://discord.com/invite/7cJ8BhAXhu) for migration support.
