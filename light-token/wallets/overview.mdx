---
title: "Integration Guide for Wallet Applications"
...
<Note>
Find a full code example: [instruction](https://github.com/Lightprotocol/examples-light-token/blob/main/toolkits/payments/send/send-instruction.ts) | [action](https://github.com/Lightprotocol/examples-light-token/blob/main/toolkits/payments/send/send-action.ts).
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="Smart wallets" icon="vault" href="/light-token/wallets/smart-wallets">
  </Card>
</CardGroup>
