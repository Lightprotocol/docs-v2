...
Our token API's optimize the account creation cost component. You'll need to create an account (1) when onboarding a new user, or (2) when the recipient of a transfer does not hold the token yet. 
