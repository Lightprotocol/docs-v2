...
- See [gasless transactions](/light-token/wallets/gasless-transactions).
</Info>
...
<CardGroup cols={2}>
<Card title="Send a basic payment" icon="arrow-right" href="/light-token/payments/send-payments/basic-payment">
  Single token transfer with Light Token.
</Card>
<Card title="Accept payments" icon="arrow-down" href="/light-token/payments/accept-payments/receive-payments">
  Load cold accounts and share your address.
</Card>
