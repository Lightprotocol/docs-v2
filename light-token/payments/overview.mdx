...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>`getAtaInterface` returns a unified balance for a given mint held in Light Token accounts. With `wrap=true`, it also includes SPL and Token 2022 balances.</td>
    </tr>
    <tr>
      <td>**Wrap / Unwrap**</td>
