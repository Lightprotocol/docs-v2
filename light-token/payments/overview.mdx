...
<Accordion title="Supported extensions by Light Token">
...
<Card title="When using Solana Wallet Adapter" icon="wallet" href="/light-token/wallets/wallet-adapter" horizontal />
