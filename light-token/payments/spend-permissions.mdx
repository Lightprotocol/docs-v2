...
import SplDelegateApprove from "/snippets/code-snippets/payments/spl/delegate-approve.mdx";
import SplDelegateCheck from "/snippets/code-snippets/payments/spl/delegate-check.mdx";
import SplDelegateTransfer from "/snippets/code-snippets/payments/spl/delegate-transfer.mdx";
import SplDelegateRevoke from "/snippets/code-snippets/payments/spl/delegate-revoke.mdx";
