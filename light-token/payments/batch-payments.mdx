...
import BatchSendActionCode from "/snippets/code-snippets/payments/send/batch-send-action.mdx";
import BatchSendInstructionCode from "/snippets/code-snippets/payments/send/batch-send-instruction.mdx";
...
[instruction](https://github.com/Lightprotocol/examples-light-token/blob/main/toolkits/payments/send/batch-send-instruction.ts) |
[action](https://github.com/Lightprotocol/examples-light-token/blob/main/toolkits/payments/send/batch-send-action.ts).
</Note>
