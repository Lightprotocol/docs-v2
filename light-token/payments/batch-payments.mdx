...
[single transaction](https://github.com/Lightprotocol/examples-light-token/blob/main/toolkits/payments/batch-send-single-tx.ts) |
[sequential](https://github.com/Lightprotocol/examples-light-token/blob/main/toolkits/payments/batch-send.ts).
</Note>
