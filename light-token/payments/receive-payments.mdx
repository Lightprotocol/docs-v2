...
3. See the [Solana documentation](https://solana.com/docs/payments/accept-payments) for using drop-in components, the Solana Pay protocol, or direct RPC integration.
