...
description: "Send a single token transfer with Light Token APIs for stablecoin payments with comparison to SPL."
...
The SDK checks whether the sender's account has a cold balance and adds load instructions if needed.
