...
import { createAssociatedTokenAccountInstruction } from "@lightprotocol/compressed-token/unified";
...
#### How do I query light-token and compressed token balances?
Standard Solana RPC works for light-token accounts (Solana accounts).
