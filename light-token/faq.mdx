...
### Get Started
<CardGroup cols={2}>
  <Card title="Toolkits" href="/light-token/welcome#integration-toolkits" color="#0066ff" style={{backgroundColor: '#2563eb', color: 'white'}}>
    Dedicated guides for specific use cases.
  </Card>
  <Card title="Cookbook" href="/light-token/welcome#cookbook">
