...
| Example | Description |
|---------|-------------|
| [create-mint](https://github.com/Lightprotocol/program-examples/blob/main/c-token/tests/client-create-cmint.rs) | Create compressed mint with metadata |
| [create-token-account](https://github.com/Lightprotocol/program-examples/blob/main/c-token/tests/client-create-ctoken.rs) | Create light-token account |
| [create-ata](https://github.com/Lightprotocol/program-examples/blob/main/c-token/tests/client-create-cata.rs) | Create associated light-token account |
| [mint-tokens](https://github.com/Lightprotocol/program-examples/blob/main/c-token/tests/client-mint-to-ctoken.rs) | Mint tokens to light-token account |
...
| [close-token-account](https://github.com/Lightprotocol/program-examples/blob/main/c-token/tests/client-close-ctoken.rs) | Close light-token account |
