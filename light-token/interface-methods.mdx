...
[View on GitHub](https://github.com/Lightprotocol/light-protocol/tree/main/js/compressed-token/src/v3)
...
|--------------|-------------|---------|
| **c-token ATA (hot)** | On-chain decompressed balance, immediately usable | Solana account |
| **Cold Account** | Compressed off-chain balance, requires validity proof to access | Merkle tree |
| **SPL Interface PDA** | Bridge account for wrap/unwrap operations | PDA holding SPL tokens |
