...
description: "Guide for Wallet Applications to add light-token APIs."
---
...
<Note>
Find devnet examples here [https://github.com/Lightprotocol/light-token-toolkit](https://github.com/Lightprotocol/light-token-toolkits).
</Note>
