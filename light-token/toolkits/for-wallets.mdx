...
<CardGroup cols={3}>
  <Card title="Sign with Privy" icon="key" href="/light-token/toolkits/for-privy">
  </Card>
  <Card title="Sign with Wallet Adapter" icon="wallet" href="/light-token/toolkits/for-wallet-adapter">
  </Card>
  <Card title="Sponsor Rent Top-Ups for Users" icon="hand-holding-dollar" href="/light-token/toolkits/sponsor-top-ups">
  </Card>
</CardGroup>
