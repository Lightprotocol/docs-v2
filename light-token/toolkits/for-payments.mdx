---
title: "light-token Toolkit for Stablecoin Payments"
...
<Info>
Get an [overview to light-token's here](/light-token/README).
</Info>
...
<Note>
Find devnet examples at [here](https://github.com/Lightprotocol/light-token-toolkits).
</Note>
