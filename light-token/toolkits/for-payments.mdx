...
// Returns TransactionInstruction[][]. Each inner array is one transaction. Almost always returns just one.
...
You can optimize sending by parallelizing the loads, and sending the transfer instruction after.
