...
<CardGroup cols={2}>
  <Card
    title="Create Mint (CPI)"
    href="/light-token/cookbook/create-mint#program-guide"
  >
    invoke / invoke_signed examples
  </Card>
  <Card
    title="Mint Tokens (CPI)"
    href="/light-token/cookbook/mint-tokens#program-guide"
  >
    MintToCTokenCpi builder
  </Card>
  <Card
    title="Transfer (CPI)"
    href="/light-token/cookbook/transfer-interface#program-guide"
  >
