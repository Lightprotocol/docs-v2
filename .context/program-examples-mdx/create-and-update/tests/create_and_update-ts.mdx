---
title: "create-and-update/tests/create_and_update.ts"
description: "https://github.com/Lightprotocol/program-examples/blob/main/create-and-update/tests/create_and_update.ts"
---
