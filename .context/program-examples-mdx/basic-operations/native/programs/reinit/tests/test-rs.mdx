---
title: "basic-operations/native/programs/reinit/tests/test.rs"
description: "https://github.com/Lightprotocol/program-examples/blob/main/basic-operations/native/programs/reinit/tests/test.rs"
---
