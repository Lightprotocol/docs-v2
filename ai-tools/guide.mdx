...
<Accordion title="Alternative: DeepWiki Web" icon="globe">
  If you don't have the MCP installed, use DeepWiki in your browser.

  <a href="https://deepwiki.com/Lightprotocol/light-protocol">
